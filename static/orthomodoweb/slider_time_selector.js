$(document).ready(function() {
		$("#slider-range").slider({
			...
			slide: function (e, ui) {
				...
				$('#id_start_time').val(hours1 + ':' + minutes1);
				...
				$('#id_end_time').val(hours2 + ':' + minutes2);
				...
				$( "#slider-range" ).slider('values',0,start_time_total_minutes);
				$( "#slider-range" ).slider('values',1,end_time_total_minutes);
